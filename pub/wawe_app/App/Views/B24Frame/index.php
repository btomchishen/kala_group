        ...
        <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary">Старт</a>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Подключено к wawe.<br> Пользователь: <?=$waweUser?> <br>Бизнес: <?=$waweBusiness?></p>
                    <a href="<?=SITE_DOMAIN.RELATIVE_PATH."/waweDisconect?DOMAIN=".$portal_domain."&AUTH_ID=".$access_token."&wawe_disconect=Y"?>" class="btn btn-danger">Отключить</a>
                </div>
            </div>
        </div>
    </div>
